...
;
},{"./vnode.js":"node_modules/snabbdom/build/package/vnode.js","./is.js":"node_modules/snabbdom/build/package/is.js"}],"src/01basicusage.js":[function(require,module,exports) {
"use strict";
...
var vnode = (0, _h.h)('div#container.box', "hello-snabbdom");
var app = document.querySelector('#app'); // 如果传递带有父节点的DOM元素，newVnode将被转换为DOM节点，传递的元素将被创建的DOM节点替换。如果传递旧的vnode, Snabbdom将有效地修改它以匹配新vnode中的描述。
// 这里就是 将app真实Dom想转成虚拟DOM， 然后和新虚拟dom比较，更新DOM ，并返回DOM

var oldNode = patch(app, vnode);
setTimeout(function () {
  vnode = (0, _h.h)('div#container.box', '变身----呵呵怪');
  patch(oldNode, vnode);
}, 2000);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "2538" + '/');
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/01basicusage.js"], null)
//# sourceMappingURL=/01basicusage.d7945570.js.map