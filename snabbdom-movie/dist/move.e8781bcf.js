...
},{"./vnode.js":"node_modules/snabbdom/build/package/vnode.js","./is.js":"node_modules/snabbdom/build/package/is.js","./htmldomapi.js":"node_modules/snabbdom/build/package/htmldomapi.js"}],"node_modules/snabbdom/build/package/h.js":[function(require,module,exports) {
"use strict";
...
;
},{"./vnode.js":"node_modules/snabbdom/build/package/vnode.js","./is.js":"node_modules/snabbdom/build/package/is.js"}],"node_modules/snabbdom/build/package/modules/class.js":[function(require,module,exports) {
"use strict";
...
},{}],"src/move.js":[function(require,module,exports) {
"use strict";
...
var _props = require("snabbdom/build/package/modules/props.js");
...
var originalData = [{
  rank: 1,
  title: "肖申克的救赎 ",
  desc: "20世纪40年代末，小有成就的青年银行家安迪（蒂姆·罗宾斯 Tim Robbins 饰）因涉嫌杀害妻子及她的情人而锒铛入狱。在这座名为鲨堡的监狱内，希望似乎虚无缥缈，终身监禁的惩罚无疑注定了安迪接下来灰暗绝望的人生。",
  elmHeight: 0,
  score: 9.7
}, {
  rank: 2,
  title: "霸王别姬",
  desc: "T段小楼（张丰毅）与程蝶衣（张国荣）是一对打小一起长大的师兄弟，两人一个演生，一个饰旦，一向配合天衣无缝，尤其一出《霸王别姬》，更是誉满京城，",
  elmHeight: 0,
  score: 9.6
}, {
  rank: 3,
  title: "阿甘正传",
  desc: "阿甘（汤姆·汉克斯 饰）于二战结束后不久出生在美国南方阿拉巴马州一个闭塞的小镇，他先天弱智，智商只有75，然而他的妈妈是一个性格坚强的女性，她常常鼓励阿甘“傻人有傻福”，要他自强不息。",
  elmHeight: 0,
  score: 9.2
}, {
  rank: 4,
  title: "这个杀手不太冷 Léon",
  desc: "里昂（让·雷诺饰）是名孤独的职业杀手，受人雇佣。一天，邻居家小姑娘马蒂尔达（纳塔丽·波特曼饰)敲开他的房门，要求在他那里暂避杀身之祸",
  elmHeight: 0,
  score: 9.4
}, {
  rank: 5,
  ...
  rank: 6,
  title: "忠犬八公的故事",
  desc: "八公（Forest 饰）是一条谜一样的犬，因为没有人知道它从哪里来。教授帕克（理查·基尔 Richard Gere 饰）在小镇的火车站拣到一只走失的小狗",
  elmHeight: 0,
  score: 9.3
}];
var data = [originalData[0], originalData[1], originalData[2], originalData[3], originalData[4], originalData[5]];
var vnode = null;
var patch = (0, _init.init)([_class.classModule, _props.propsModule, _style.styleModule, _eventlisteners.eventListenersModule]); // 渲染每条movie
...
function movieView(movie) {
  ...
  }, movie.rank), (0, _h.h)('div', movie.title), (0, _h.h)('div', movie.desc), (0, _h.h)('div', movie.score), (0, _h.h)('div.btn.rm-btn', {
    on: {
      click: [remove, movie]
    }
  }, 'x')]);
...
function remove(movie) {
  console.log(movie);
  var tmp = [];
  data.forEach(function (movieItem) {
...
function render() {
  ...
  var newvnode = (0, _h.h)('div.list', {}, view(data));
  vnode = patch(vnode, newvnode);
}

function view(data) {
  return (0, _h.h)('div', [(0, _h.h)('h1', '豆瓣 TOP250--我有故事，你有酒吗🤪'), (0, _h.h)('div', [(0, _h.h)('span', '按以下排序： '), (0, _h.h)('button', {
    on: {
  ...
  }, 'Title')]), (0, _h.h)('div', [(0, _h.h)('button', {
    on: {
      click: [addOne]
    }
  }, '新增一条')]), (0, _h.h)('div', data.map(movieView))]);
}
...
},{"snabbdom/build/package/init":"node_modules/snabbdom/build/package/init.js","snabbdom/build/package/h":"node_modules/snabbdom/build/package/h.js","snabbdom/build/package/modules/class.js":"node_modules/snabbdom/build/package/modules/class.js","snabbdom/build/package/modules/props.js":"node_modules/snabbdom/build/package/modules/props.js","snabbdom/build/package/modules/style":"node_modules/snabbdom/build/package/modules/style.js","snabbdom/build/package/modules/eventlisteners":"node_modules/snabbdom/build/package/modules/eventlisteners.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "6071" + '/');
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/move.js"], null)
//# sourceMappingURL=/move.e8781bcf.js.map